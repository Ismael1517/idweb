...
\newcommand{\itemInput}{Del 19 Mayo 2025}
\newcommand{\itemOutput}{Al 26 Mayo 2025}
...
\begin{document}
	...
	\begin{itemize}
		...
		\item \url{https://github.com/Ismael1517/IDWeb.git}
		\item URL para el laboratorio 01 en el Repositorio GitHub.
		\item \url{https://github.com/Ismael1517/IDWeb/tree/main/Lab01}
	\end{itemize}
	...
	\end{lstlisting}
	\begin{lstlisting}[language=bash,caption={Dirijíéndonos al directorio de trabajo}]
		$ cd $HOME/rescobedoq/
	\end{lstlisting}	
	...
	\subsection{Commits}
	\begin{lstlisting}[language=bash,caption={Primer Commit Creando carpeta/archivo para laboratorio 01}]
		$ mkdir lab01
	...
	\begin{lstlisting}[language=bash,caption={Compilando y probando código}]
		$ cd lab01
		...
		1 2 4 4 5 6
	\end{lstlisting}
	\begin{lstlisting}[language=bash,caption={Commit: Probando algoritmo de Inserción con arreglo}]
		$ git add .
